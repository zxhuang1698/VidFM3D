...
# run in bash:
# for file in vidfm3d/data/DL3DV/DL3DV-processed/1K/0*.sft; do hash=$(basename "$file" .sft); python -m vidfm3d.data.processing.visualize_sft --sft "$file" --output vidfm3d/data/DL3DV/DL3DV-10K/test_output/"$hash"; done
