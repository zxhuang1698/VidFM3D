...
class DiskOffloader(Offloader):
    def __init__(
        self, dir_name: str, n_entries: int = 16, backend: str = "uring"
    ) -> None:
    ...
    def async_write(
        self, tensor: torch.Tensor, callback: Optional[Callable[[], None]] = None
    ) -> None:
    ...
    def async_writev(
        self, tensors: List[torch.Tensor], callback: Optional[Callable[[], None]] = None
    ) -> None:
